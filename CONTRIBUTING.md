...
Welcome to `assorthead` contributor's guide.
...
If you experience bugs or general issues with `assorthead`, please have a look
...
You can help improve `assorthead` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`assorthead` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `assorthead`'s files. While this mechanism can
...
```
conda create -n assorthead python=3 six virtualenv pytest pytest-cov
conda activate assorthead
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/assorthead.git
   cd assorthead
   ```
...
5. Install [pre-commit]:
   ...
   `assorthead` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/assorthead
[issue tracker]: https://github.com/<USERNAME>/assorthead/issues
